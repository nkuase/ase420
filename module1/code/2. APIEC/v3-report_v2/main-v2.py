from employee_v2_familyname import Manager, Attendant, Cook, Mechanic
...
def print_accounting_report():
    ...
    print("==========")
    for e in employees:
        print(f"{e.last_name},{e.first_name}, ${e.salary}")

def print_staffing_report():
    print("Staffing")
    print("========")
    for e in employees:
        print(f"{e.last_name},{e.first_name}, {e.job_title}")
