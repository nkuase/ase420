...
What does the SOLID acronym stand for, who organized and popularized these principles, and who coined the SOLID acronym?
...
This is an example of using polymorphism to solve OCP violations. Explain how this code solves the OCP violation.
...
## Question 1.13 (Advanced / Discussion)

1. **Easy Extension**: Adding new types doesn't require changing existing code — just create a new class and implement the polymorphic method.
2. **Easy Removal**: Subclasses can be deleted or replaced without modifying dispatch logic elsewhere.

These are two main advantages of following OCP. However, what is a potential cost or trade-off of applying OCP and polymorphism everywhere unconditionally?
...
- Can add/remove types without touching existing dispatch code

This is a list of the benefits of using this principle. What is this principle, and how do you know if your code follows it?
