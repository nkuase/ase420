...
- New report types can be added without modifying the existing dispatch code.
...
If we create a subclass for every combination of Color, Shape, and Size, what design problem will occur?
