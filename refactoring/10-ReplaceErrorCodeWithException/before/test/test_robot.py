...
Tests robot creation, command execution, movement, and error handling
"""
import unittest
import sys
import os
...
class TestRobot(unittest.TestCase):
    ...
    def test_execute_command_turn_left(self):
        """Test left turn command execution"""
        robot = Robot("TestBot")
        result = robot.execute_command("left")
        self.assertTrue(result)
    ...
    def test_execute_command_invalid(self):
        """Test invalid command execution returns False"""
        robot = Robot("TestBot")
        result = robot.execute_command("invalid")
