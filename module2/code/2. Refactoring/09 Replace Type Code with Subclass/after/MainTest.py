...
class TestShape(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.line = Shape.create_shape(Shape.TYPECODE_LINE, 0, 0, 100, 200)
        self.rectangle = Shape.create_shape(Shape.TYPECODE_RECTANGLE, 10, 20, 30, 40)
        self.oval = Shape.create_shape(Shape.TYPECODE_OVAL, 100, 200, 300, 400)
